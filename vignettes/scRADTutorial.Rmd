...
df_tlr = read.xlsx(xlsxFile = paste0(table_dir,
                                 "Gayo_Revised_Table_S8.xlsx"))
tlr_expr = t(df_tlr[,-1])
colnames(tlr_expr) = df_tlr[,1]
