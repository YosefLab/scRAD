...
estimate a separate offset, cluster effect (`c1` vs `c3-5`), and patient
...
presented in our manuscript pooled cells from patients `P1` and `P2` to form
...
in the previous subsection, but treat each patient as a replicate pool.
